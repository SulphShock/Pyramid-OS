...
ShellRoot {
                ...
                anchors.fill: parent; anchors.leftMargin: 6; anchors.rightMargin: 6; spacing: 0
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            Icon { name: "sun"; sz: 14; col: root.fg; anchors.centerIn: parent }
                        ...
                        Rectangle {
                            ...
                            Icon { name: "clip"; sz: 14; col: root.fg; anchors.centerIn: parent }
                        ...
                        Rectangle {
                            ...
                            Icon { name: "remind"; sz: 14; col: root.fg; anchors.centerIn: parent }
                        ...
                        Rectangle {
                            ...
                            Icon { name: "power"; sz: 14; col: root.fg; anchors.centerIn: parent }
    ...
    Overlay {
        ...
        RowLayout {
            Layout.fillWidth: true; spacing: 8
            Icon { name: "moon"; sz: 14; col: root.fg; opacity: root.dnd ? 1 : 0.4 }
